    ...
    <div class="sl-mainpanel">
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                @if ($newdate2 == '')
                    <h6 class="card-body-title text-center">
                        <h5 class="text-center"> Total Amount of {{ $newdate }} is {{ $total }}</h5>
                    </h6>
                @endif

                @if ($newdate2 != '')
                    <h6 class="card-body-title text-center">
                        <h5 class="text-center"> Total Amount of from {{ $newdate }} to {{ $newdate2 }} is
                            {{ $total }}</h5>
                    </h6>
                @endif
