            ...
            <div class="card pd-20 pd-sm-40 col-lg-12">
                ...
                <div>
                    ...
                    <div class="d-flex align-items-center justify-content-end" style="margin-top:-5%">
                        <form method="post" action="{{ url('admin/update/order/' . $order->id) }} "
                ...
                <div class="container-fluid card" style="border: 2px solid black;">
                    ...
                    <div class="row row-cols-2 row-cols-lg-3 g-2 g-lg-5">
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-title" style="color:black">Order Number &nbsp;&nbsp; :
                                        {{ $order->order_number }}</p>
                                    <p class="card-title" style="color:black;">invoice number&nbsp;&nbsp; : Invoice
                                        {{ $order->id }}
                                        @if ($order->status == 0)
                                    ...
                                    <p class="card-title" style="color:black;">Customer Name &nbsp;&nbsp;&nbsp;&nbsp;:
                                        <span>{{ $order->name }}</span></p>
                                    <p class="card-title" style="color:black;">Customer Phone &nbsp&nbsp;&nbsp;:
                                        <span>{{ $order->phone }}</span></p>
                                    <p class="card-title" style="color:black;">Customer Address :
                                        <span>{{ $order->present_address }}</span></p>
                                    <p class="card-title" style="color:black;">Shipping Address &nbsp;:
                                        <span>{{ $shipping->ship_address }}</span></p>
                                </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title" style="color:black;">Supplier Name : <span>Enjtexbd Limited</span>
                                    </p>
                                    <p class="card-title" style="color:black;">Supplier Email:
                                        <span>enjtexbd@gmail.com</span></p>
                                    <p class="card-title" style="color:black;">Supplier phone: <span>+8801779174858</span>
                                    </p>
